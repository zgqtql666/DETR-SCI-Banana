...
if __name__ == "__main__":
    # 加载模型
    model = YOLO("D:/yolo/zgq/YOLOv8-Magic-main/ultralytics-8.1.0/runs/train/exp13/weights/best.pt")  # YOLOv8n模型
    model.predict(
        source="D:/yolo/zgq/YOLOv8-Magic-main/predetect/yinmi/",
        save=True,  # 保存预测结果
        ...
        name="Banana",  # 实验名称，结果保存在'project/name'目录下（可选）
